package com.covidinvaders.sprite;
...
public class SpriteAnimation {
    ...
    private void playAnimation() {
        if (timer.isTimerReady(animationSpeed) && currentSprite != limit && !isDestroyAfterAnimation()) {
            play = false;
            currentSprite = 0;
        } else if (timer.isTimerReady(animationSpeed) && currentSprite == limit && isDestroyAfterAnimation()) {
            sprites = null;
        } else if (timer.timerEvent(animationSpeed) && currentSprite != limit) {
            currentSprite++;
        }
